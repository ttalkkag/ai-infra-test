...
| Prometheus — Histograms & summaries | https://prometheus.io/docs/practices/histograms/ | Prometheus | 롤링 | 2026-06-26 | 공식/높음 | 낮음 | quantile 오차는 rank 기준; quantile 평균은 "BAD!"; histogram=서버측 계산, summary=클라이언트측 |
...
- **Prometheus quantile 주의:** quantile 오차는 rank 기준; quantile 평균은 "BAD!"; histogram=서버측 `histogram_quantile()` 집계 가능. — [Prometheus](https://prometheus.io/docs/practices/histograms/)
